...
// forked from outdoor-v4) was reverted here because it 403'd globally — a
// custom style only renders with a key from the account that owns it AND while
// it's published. Restore it once that's sorted in cloud.maptiler.com.
